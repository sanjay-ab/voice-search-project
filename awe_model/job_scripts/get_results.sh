...
ACC=1000
BS=5
TRAINING_LANGUAGE=tamil
EPOCH=1
PREFIX=""
TRAIN_SEQ=3_9
SAVE_EMBEDDING_FOLDER="train_${TRAINING_LANGUAGE}_${PREFIX}lr_${LR}_tmp_${TMP}_acc_${ACC}_bs_${BS}_epoch_${EPOCH}_${MIN_PHONE_SEQ_LENGTH}_${MAX_PHONE_SEQ_LENGTH}_${TRAIN_SEQ}"
MODEL_SAVE_DIR="data/${TRAINING_LANGUAGE}/models/awe/${LAYER}/${PREFIX}lr_${LR}_tmp_${TMP}_acc_${ACC}_bs_${BS}_${TRAIN_SEQ}"
MODEL_NAME="2024-07-20_23:47:58_checkpoint_epoch_${EPOCH}.pt"
RESULTS_PATH="${LAYER}/${TRAINING_LANGUAGE}_train_3_9_queries_cut_after_embedding/${PREFIX}lr_${LR}_tmp_${TMP}_acc_${ACC}_bs_${BS}_${MIN_PHONE_SEQ_LENGTH}_${MAX_PHONE_SEQ_LENGTH}_${TRAIN_SEQ}_epoch_${EPOCH}"
MODEL_TYPE="awe"
