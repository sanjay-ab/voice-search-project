...
MODEL_NAME="2024-07-23_12:57:16_checkpoint_epoch_${EPOCH}.pt"
RESULTS_PATH="${LAYER}/tamil_train_init_3_9/${PREFIX}lr_${LR}_tmp_${TMP}_acc_${ACC}_bs_${BS}_${MIN_PHONE_SEQ_LENGTH}_${MAX_PHONE_SEQ_LENGTH}_${TRAIN_SEQ}_epoch_${EPOCH}"
MODEL_TYPE="awe"
